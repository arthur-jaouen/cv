        ...
        <Job
            ...
            description={{
                en: (
                    <>
                        <p>
                            Comerso&apos;s goal is to help retail and industry adopt a zero-waste strategy with a strong
                            technological approach. Comerso provides multiple solutions to handle the end of life of
                            retail products :
                        </p>
                        <ul>
                        ...
                        <p>
                            ...
                            continuous integration workflow based on Azue DevOps. As a full stack developer, I worked on
        ...
        <Job
            ...
            description={{
                ...
                fr: (
                    <>
                        <p>
                            Réalisation d&apos;une API REST pour une société de portage salarial sur une base de données
                            existante
                        </p>
                    </>
                ),
